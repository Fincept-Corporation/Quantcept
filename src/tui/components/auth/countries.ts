/** Country dial codes for the register picker. `dial` excludes the leading "+". */
export interface Country {
  name: string
  dial: string
}

// Sovereign states + major territories with their E.164 country calling codes.
export const COUNTRIES: Country[] = [
  ...
  { name: "Congo (Kinshasa, DRC)", dial: "243" },
...
/** Filter by country name or dial code (a leading "+" in the query is ignored). */
